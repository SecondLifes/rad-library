...
class UserHandler:
    async def create_user(self, request: Request) -> Response:
        ...
        return Response({"id": user.id, "email": user.email}, status=201)  # Response formatting
...
│  - Domain rules and validation, orchestration         │
└─────────────────────────────────────────────────────┘
                        │
                        ▼
┌─────────────────────────────────────────────────────┐
...
# and even then, sometimes explicit is better than abstract.
```
